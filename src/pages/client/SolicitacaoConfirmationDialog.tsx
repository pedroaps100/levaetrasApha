                ...
                <div className="max-h-[70vh] overflow-y-auto p-1 pr-4 space-y-4">
                    ...
                    <div>
                     ...
                     <div className="space-y-2 pt-2">
                        <div className="flex justify-between font-semibold text-lg"><span>Valor Total da Entrega:</span><span>{formatCurrency(solicitacaoData.valorTotalTaxas)}</span></div>
                        {solicitacaoData.valorTotalRepasse > 0 && <div className="flex justify-between font-medium"><span>Valor Total dos Produtos (Repasse):</span><span>{formatCurrency(solicitacaoData.valorTotalRepasse)}</span></div>}
                     </div>
                </div>
